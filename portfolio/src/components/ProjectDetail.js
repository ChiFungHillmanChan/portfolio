...
const GAME_SUBDOMAIN_SLUGS = new Set(['chat-box', 'prompt-hunter', 'card-game', 'dream-record', 'casino-game', 'system-design', 'connect4', 'card-drawer', 'da-siu-yan', 'math-memory', 'siu-hei-bou']);
