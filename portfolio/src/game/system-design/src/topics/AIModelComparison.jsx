...
function OverviewTab() {
  return (
    <div className="card">
      <h2>AI Model 大比拼：GPT-5.2 Codex vs Opus 4.6 vs Gemini 3 vs DeepSeek vs Cursor</h2>
      ...
      <div className="diagram-container">
        <svg viewBox="0 0 750 470" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="95" y="78" textAnchor="middle" fill="#10B981" fontSize="11" fontWeight="700">GPT-5.2 Codex</text>
          ...
          <text x="672" y="83" textAnchor="middle" fill="#d1d5db" fontSize="10">$1.75-14</text>
      ...
      <ol className="steps">
        <li><span className="step-num">1</span><span><strong style={{ color: '#10B981' }}>GPT-5.2 Codex</strong>：Agentic coding 強項明顯。400K context，multimodal 能力完整，reasoning 同 coding 平衡。API 生態成熟，適合需要 multimodal + code generation 嘅場景。</span></li>
      ...
      <div className="key-points">
        <div className="key-point">
          ...
          <p>
            ...
            <strong style={{ color: '#F59E0B' }}>10K-100K tokens</strong>：GPT-5.2 Codex (400K) 或 Opus 4.x（200K 常見；API 可到 1M）。<br />
            <strong style={{ color: '#ef4444' }}>100K+ tokens</strong>：Gemini Pro (1M) 或 Opus API 1M 路線。要食成個 codebase，長 context 模型會更穩。
          </p>
        </div>
        <div className="key-point">
          <h4>2. Multimodal 需求 (Image/Audio/Video)</h4>
          <p>
            <strong style={{ color: '#10B981' }}>圖片 + 代碼分析</strong> → GPT-5.2 Codex：screenshot 加 error message 一齊餵入去，分析最準。<br />
        ...
        <div className="key-point">
          ...
          <p>
            ...
            <strong style={{ color: '#F59E0B' }}>中等預算</strong> → GPT-5.2 Codex / Claude Sonnet：性能同成本嘅最佳平衡。<br />
    ...
    <div className="card">
      ...
      <ol className="steps">
        ...
        <li>
          ...
          <span>
            <strong style={{ color: '#10B981' }}>Image + Code Debugging → GPT-5.2 Codex</strong><br />
            場景：用戶報告 UI bug，附咗 screenshot 同 console error。你需要 AI 同時分析圖片同 error log。<br />
            點解揀 GPT-5.2 Codex：Multimodal 能力最強，可以同時理解 screenshot 入面嘅 UI 狀態同 error message 嘅 stack trace，cross-reference 兩者搵出 root cause。<br />
      ...
      <div className="use-case">
        <h4>實戰心得</h4>
        <p>大部分工程團隊嘅最佳策略係<strong>「多 model 混合使用」</strong>：日常任務用 Gemini 3 Flash 或 DeepSeek V3.2 省錢，複雜 coding 用 Claude Opus 4.6 保質量，multimodal 場景用 GPT-5.2 Codex。唔好鎖死一個 model——用 abstraction layer 包住 API call，隨時可以切換。</p>
      </div>
    </div>
  );
}
...
可選嘅 Model：
- GPT-5.2 Codex (400K context, agentic coding, $1.75-14/1M)
- Claude Opus 4.6 (1M context 只限 API；一般對話常見 200K, 高質量推理, $5-25/1M)
- Gemini 3 Pro (1M context, multimodal 強, $2-12/1M；>200K prompt 會到 $4-18/1M)
  ...
  const questions = [
    {
      ...
      options: ['Claude Opus 4.6 (1M API only)', 'Gemini 3 Pro (1M)', 'GPT-5.2 Codex (400K)', 'Gemini 3 Flash (1M)'],
      correct: 2,
      explanation: 'GPT-5.2 Codex 400K 仍然裝唔落 500K token codebase。Gemini 3 Pro 1M 會更穩；Opus 路線要按實際可用 context 配置。',
    },
    {
      id: 2,
      question: '你要 batch 處理 50,000 條用戶反饋做情緒分類，揀邊個 model 最合理？',
      options: ['Claude Opus', 'GPT-5.2 Codex', 'Gemini 3 Flash', 'Cursor'],
      correct: 2,
    ...
    },
    {
      ...
      options: ['Claude Opus 4.6', 'Gemini 3 Flash', 'GPT-5.2 Codex', 'Gemini 3 Pro'],
      correct: 2,
      explanation: 'GPT-5.2 Codex 嘅 multimodal 能力最強，可以同時分析 screenshot 入面嘅 UI 狀態同 error log 嘅 stack trace，cross-reference 搵出 root cause。',
    },
    {
      id: 4,
      question: '以下邊個講法係錯嘅？',
      options: [
        ...
        'GPT-5.2 Codex 嘅 multimodal 能力好強',
      ],
      correct: 2,
    ...
    },
    {
      ...
      correct: 2,
      explanation: '冇一個 model 係萬能嘅。最佳策略係 multi-model 混合使用：日常用 Flash 或 DeepSeek V3.2（開源最平）省錢，複雜 coding 用 Claude，multimodal 用 GPT-5.2 Codex。用 abstraction layer 包住 API，隨時切換。',
    },
  ];
  ...
  return (
    <>
      <TopicTabs
        ...
        subtitle="GPT-5.2 Codex vs Opus 4.6 vs Gemini 3 vs DeepSeek 深度比較——工程師點樣揀最啱嘅 AI Model"
        tabs={[
