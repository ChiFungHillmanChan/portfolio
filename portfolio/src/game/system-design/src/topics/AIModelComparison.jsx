...
function OverviewTab() {
  return (
    <div className="card">
      <h2>AI Model 大比拼：GPT-5.4 vs Opus 4.6 vs Gemini 3 vs DeepSeek vs Cursor</h2>
      ...
      <div className="diagram-container">
        <svg viewBox="0 0 750 470" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="95" y="78" textAnchor="middle" fill="#10B981" fontSize="11" fontWeight="700">GPT-5.4</text>
          <text x="95" y="93" textAnchor="middle" fill="#6b7280" fontSize="9">(OpenAI)</text>
          <text x="230" y="83" textAnchor="middle" fill="#d1d5db" fontSize="11">1.05M</text>
          ...
          <text x="672" y="83" textAnchor="middle" fill="#d1d5db" fontSize="10">$2.50-15</text>
          ...
          <text x="230" y="136" textAnchor="middle" fill="#34d399" fontSize="11" fontWeight="700">1M*</text>
          ...
          <text x="672" y="136" textAnchor="middle" fill="#d1d5db" fontSize="10">$5-25</text>

          {/* Row 3 - Gemini 3.1 Pro */}
          <rect x="10" y="161" width="730" height="48" rx="6" fill="#1a2332" stroke="#334155" strokeWidth="1" />
          <text x="95" y="184" textAnchor="middle" fill="#3B82F6" fontSize="11" fontWeight="700">Gemini 3.1 Pro</text>
          ...
          <text x="672" y="189" textAnchor="middle" fill="#d1d5db" fontSize="10">$2-12 / $4-18*</text>
          ...
          <text x="672" y="242" textAnchor="middle" fill="#34d399" fontSize="10" fontWeight="700">$0.50-3</text>
          ...
          <text x="375" y="438" textAnchor="middle" fill="#34d399" fontSize="9" fontWeight="600">綠色 = 該類別最強 / 最抵（*Opus 1M 只限 API；Gemini Pro &gt;200K prompt 會加價）</text>
        </svg>
      </div>

      <ol className="steps">
        <li><span className="step-num">1</span><span><strong style={{ color: '#10B981' }}>GPT-5.4</strong>：Agentic coding + Computer Use 強項明顯。1.05M context，multimodal 能力完整，reasoning 同 coding 平衡。API 生態成熟，適合需要 multimodal + agentic coding + Computer Use 嘅場景。$2.50-15/1M tokens。</span></li>
        <li><span className="step-num">2</span><span><strong style={{ color: '#a78bfa' }}>Claude Opus 4.x</strong>：高質量推理同深度分析。日常對話常見 200K，但 API 路徑可用 1M context。輸出質量高、價格亦屬高階（$5/$25 per 1M）。適合高價值任務。</span></li>
        <li><span className="step-num">3</span><span><strong style={{ color: '#3B82F6' }}>Gemini 3.1 Pro</strong>：Context 怪獸 + 推理大幅升級（ARC-AGI-2 77.1%）。1M token context 可以食成個 codebase，multimodal 亦好強。Tiered pricing（$2-18/1M）按用量分級收費，適合處理大量文件同長文分析。缺點係 coding 稍遜 Claude/GPT。</span></li>
        <li><span className="step-num">4</span><span><strong style={{ color: '#38bdf8' }}>Gemini 3 Flash</strong>：性價比之王。$0.50/1M input token，速度快，1M context，適合 batch processing 同唔需要頂級推理嘅任務。「夠用就好」嘅最佳選擇。</span></li>
  ...
  return (
    <div className="card">
      ...
      <div className="key-points">
        <div className="key-point">
          ...
          <p>
            ...
            <strong style={{ color: '#F59E0B' }}>10K-100K tokens</strong>：GPT-5.4 (1.05M) 或 Opus 4.x（200K 常見；API 可到 1M）。<br />
            <strong style={{ color: '#ef4444' }}>100K+ tokens</strong>：Gemini 3.1 Pro (1M) 或 Opus API 1M 路線。要食成個 codebase，長 context 模型會更穩。
          </p>
        </div>
        <div className="key-point">
          <h4>2. Multimodal 需求 (Image/Audio/Video)</h4>
          <p>
            <strong style={{ color: '#10B981' }}>圖片 + 代碼分析</strong> → GPT-5.4：screenshot 加 error message 一齊餵入去，分析最準。<br />
        ...
        <div className="key-point">
          ...
          <p>
            ...
            <strong style={{ color: '#38bdf8' }}>Budget 有限</strong> → Gemini 3 Flash：$0.50/1M input，仍然係高性價比選擇。<br />
            <strong style={{ color: '#F59E0B' }}>中等預算</strong> → GPT-5.4 / Claude Sonnet：性能同成本嘅最佳平衡。<br />
            <strong style={{ color: '#ef4444' }}>Unlimited</strong> → Claude Opus：最強 coding + reasoning，但 $25/1M output 仍然屬高價路線。
          </p>
        </div>
        <div className="key-point">
      ...
      <div className="use-case">
        <h4>快速判斷法則</h4>
        <p>如果你只記得一條規則：<strong>「超平用 DeepSeek，平嘢用 Flash，寫 code 用 Claude，睇圖用 GPT，食大 context 用 Gemini 3.1 Pro / Claude」</strong>。呢幾句已經涵蓋 90% 嘅場景。</p>
      </div>
    </div>
  );
}
...
function PracticeTab() {
  return (
    <div className="card">
      ...
      <ol className="steps">
        <li>
          ...
          <span>
            ...
            點解揀 Claude：API 路徑有 1M context，可以食得落成個 codebase；coding 能力最強可以發現深層 bug，推理能力幫你搵到跨文件嘅安全漏洞。而且 Anthropic 嘅 privacy policy 適合處理敏感代碼。<br />
            <strong>成本預估</strong>：~$0.5 input + ~$2.5 output = ~$3/次（視 token 分佈而變）。貴但值得。
          </span>
        </li>
        <li>
          <span className="step-num">2</span>
          <span>
            <strong style={{ color: '#10B981' }}>Image + Code Debugging → GPT-5.4</strong><br />
            場景：用戶報告 UI bug，附咗 screenshot 同 console error。你需要 AI 同時分析圖片同 error log。<br />
            點解揀 GPT-5.4：Multimodal 能力最強，可以同時理解 screenshot 入面嘅 UI 狀態同 error message 嘅 stack trace，cross-reference 兩者搵出 root cause。<br />
        ...
        <li>
          ...
          <span>
            ...
            點解揀 Flash：$0.50/1M input token，10K 條 feedback 大約 5M tokens，input 成本只需 ~$2.50。速度快，1M context 可以一次過餵好多條。質量對於分類任務嚟講綽綽有餘。<br />
            更平替代：DeepSeek V3.2 只要 $0.28/1M input，開源仲可以 self-host 零 API 費用。如果你有自己嘅 GPU，呢個係終極慳錢方案。<br />
            <strong>成本預估</strong>：Flash ~$2.50 input + ~$12 output = ~$14.50/10K 條。DeepSeek 仲平。如果用 Claude Opus 做同樣嘅嘢通常要 ~$125。
          </span>
        </li>
      </ol>
      ...
      <div className="use-case">
        <h4>實戰心得</h4>
        <p>大部分工程團隊嘅最佳策略係<strong>「多 model 混合使用」</strong>：日常任務用 Gemini 3 Flash 或 DeepSeek V3.2 省錢，複雜 coding 用 Claude Opus 4.6 保質量，multimodal 場景用 GPT-5.4。唔好鎖死一個 model——用 abstraction layer 包住 API call，隨時可以切換。</p>
      </div>
    </div>
  );
}
...
可選嘅 Model：
- GPT-5.4 (1.05M context, Computer Use, agentic coding, $2.50-15/1M)
- Claude Opus 4.6 (1M context 只限 API；一般對話常見 200K, 高質量推理, $5-25/1M)
- Gemini 3.1 Pro (1M context, multimodal 強, $2-12/1M；>200K prompt 會到 $4-18/1M)
- Gemini 3 Flash (1M context, 快速, $0.50-3/1M)
  ...
  const questions = [
    {
      ...
      options: ['Claude Opus 4.6 (1M API only)', 'Gemini 3.1 Pro (1M)', 'DeepSeek V3.2 (128K)', 'GPT-5.4 (1.05M)'],
      correct: 2,
      explanation: 'DeepSeek V3.2 只有 128K context，完全裝唔落 500K token codebase。其餘三個都有 1M+ context，可以應付。',
    },
    {
      id: 2,
      question: '你要 batch 處理 50,000 條用戶反饋做情緒分類，揀邊個 model 最合理？',
      options: ['Claude Opus', 'GPT-5.4', 'Gemini 3 Flash', 'Cursor'],
      correct: 2,
      explanation: 'Gemini 3 Flash $0.50/1M input token，做大量分類任務最平最快。用 Claude Opus 做同樣嘅嘢通常會貴一個數量級。',
    },
    {
      id: 3,
      question: '用戶報咗一個 UI bug，附咗 screenshot 同 error log，你應該用邊個 model 分析？',
      options: ['Claude Opus 4.6', 'Gemini 3 Flash', 'GPT-5.4', 'Gemini 3.1 Pro'],
      correct: 2,
      explanation: 'GPT-5.4 嘅 multimodal 能力最強，可以同時分析 screenshot 入面嘅 UI 狀態同 error log 嘅 stack trace，cross-reference 搵出 root cause。',
    },
    {
      id: 4,
      question: '以下邊個講法係錯嘅？',
    ...
    },
    {
      ...
      correct: 2,
      explanation: '冇一個 model 係萬能嘅。最佳策略係 multi-model 混合使用：日常用 Flash 或 DeepSeek V3.2（開源最平）省錢，複雜 coding 用 Claude，multimodal 用 GPT-5.4。用 abstraction layer 包住 API，隨時切換。',
    },
  ];
  ...
  return (
    <>
      <TopicTabs
        ...
        subtitle="GPT-5.4 vs Opus 4.6 vs Gemini 3 vs DeepSeek 深度比較——工程師點樣揀最啱嘅 AI Model"
        tabs={[
