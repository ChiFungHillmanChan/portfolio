(() => {
  ...
  const CLIPS = {
    ...
    // two-arm circular card wash over the felt: arms reach forward-down and
    // trace counter-phase circles. Last key ≈ first key so consecutive plays
    // chain into a continuous smear; finish a wash run with armsRest.
    washCards: { track: 'arms', dur: 1600, keys: [
      { at: 0.25, ease: 'inOutCubic', joints: {
        shoulderL: { e: [-0.45, 0, 0.35] }, shoulderR: { e: [-0.45, 0, -0.35] },
        elbowL: { e: [-0.35, 0, 0] }, elbowR: { e: [-0.35, 0, 0] } } },
      { at: 0.50, ease: 'inOutCubic', joints: {
        shoulderL: { e: [-0.70, 0, 0.12] }, shoulderR: { e: [-0.25, 0, -0.55] } } },
      { at: 0.75, ease: 'inOutCubic', joints: {
        shoulderL: { e: [-0.25, 0, 0.55] }, shoulderR: { e: [-0.70, 0, -0.12] } } },
      { at: 1.00, ease: 'inOutCubic', joints: {
        shoulderL: { e: [-0.45, 0, 0.35] }, shoulderR: { e: [-0.45, 0, -0.35] } } },
    ] },
    // riffle shuffle: hands come together in front of the chest, wrists
    // alternate the interleave flick. Chains like washCards; end via armsRest.
    shuffleRiffle: { track: 'arms', dur: 1100, keys: [
      { at: 0.20, ease: 'outCubic', joints: {
        shoulderL: { e: [-0.5, 0, 0.55] }, shoulderR: { e: [-0.5, 0, -0.55] },
        elbowL: { e: [-0.85, 0, 0] }, elbowR: { e: [-0.85, 0, 0] },
        wristL: { e: [0, 0, 0.45] }, wristR: { e: [0, 0, -0.45] } } },
      { at: 0.45, ease: 'inOutCubic', joints: {
        wristL: { e: [0.35, 0, 0.15] }, wristR: { e: [0.35, 0, -0.15] } } },
      { at: 0.70, ease: 'inOutCubic', joints: {
        wristL: { e: [-0.2, 0, 0.45] }, wristR: { e: [-0.2, 0, -0.45] } } },
      { at: 1.00, ease: 'inOutCubic', joints: {
        wristL: { e: [0.25, 0, 0.3] }, wristR: { e: [0.25, 0, -0.3] } } },
    ] },
    // return both arms to rest after a chained wash/riffle sequence
    armsRest: { track: 'arms', dur: 500, keys: [
      { at: 1.00, ease: 'inOutCubic', joints: {
        shoulderL: { rest: true }, shoulderR: { rest: true },
        elbowL: { rest: true }, elbowR: { rest: true },
        wristL: { rest: true }, wristR: { rest: true } } },
    ] },
  };
